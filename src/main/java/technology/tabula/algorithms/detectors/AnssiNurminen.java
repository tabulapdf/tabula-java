...
import technology.tabula.texts.Line;
 ...
 */
public class AnssiNurminen implements DetectionAlgorithm {
    ...
    public List<Rectangle> detect(Page page) {
        ...
        if (allEdges.size() > 0) {
            ...
            List<? extends Rectangle> cells = Spreadsheet.findCells(horizontalRulings, verticalRulings);
