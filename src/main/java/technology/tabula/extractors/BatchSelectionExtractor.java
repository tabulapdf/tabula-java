...
public class BatchSelectionExtractor {
	...
	public int extract(String inputPath, String outputPath, String jsonPath, String processType, int overlapThreshold) {
		try {			
			//----------------------------------------------------------
    ...
    public static void main(String[] args) {
    	try {
			...
			//regexList.add(new RegexContainer("Analyte", "Qualifier", "Date", "By"));
			//regexList.add(new RegexContainer("A^", "B^", "C^", "D^"));
	    	
			
			// testing failed file
			// Report,Name,GASTONIA,DALLAS
			regexList.add(new RegexContainer("Report", "Name", "GASTONIA", "DALLAS"));
			regexList.add(new RegexContainer("Analyte", "Qualifier", "Date", "By"));
			//regexList.add(new RegexContainer("New Well", "Unit", "Date", "By"));
			//regexList.add(new RegexContainer("Report 1", "Report 2", "Report 3", "Report 4"));					
			regexList.add(new RegexContainer("Report 1", "Report 3"));
			*/
			
			
			BatchSelectionExtractor test = new BatchSelectionExtractor();
			
			int result = test.extract(inputPath, outputPath, jsonPath, processType, 0);
